...
## Documentation
- [Architecture Diagram](https://cloud.google.com/walkthroughs/solutions-in-console/deploy-jave-app-gce/images/arch_diagram.png)
...
| region | Compute Region to deploy to. | `string` | `"us-central1"` | yes |
...
| zones | Compute Zones to deploy to. | `list(string)` | <pre>[<br>  "us-central1-a",<br>  "us-central1-b"<br>]</pre> | yes |
