...
We also strongly recommend that you familiarize yourself with the Deploy a Java application with Compute Engine solution by reading the [solution guide](https://cloud.google.com/architecture/big-data-analytics/java-application).
