...
# Customize a Deploy a Java application with Compute Engine Solution

Learn how to build and deploy your own proof of concept based on the deployed [Deploy a Java application with Compute Engine](https://console.cloud.google.com/products/solutions/details/java-application) Jump Start Solution. You can customize the Jump Start Solution deployment by creating a copy of the source code. You can modify the infrastructure and application code as needed and redeploy the solution with the changes.
...
We also strongly recommend that you familiarize yourself with the Deploy a Java application with Compute Engine solution by reading the [solution guide](https://cloud.google.com/architecture/application-development/java-app-gce).
